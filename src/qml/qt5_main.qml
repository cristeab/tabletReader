...
Rectangle {
  ...
  function btnHnd(cmd) {
    ...
    mainLoader.height = book.height
      ...
      mainLoader.source = "qt5_filebrowser.qml"
      mainLoader.width = book.width
      mainLoader.height = book.height
      ...
      mainLoader.source = "qt5_gotopage.qml"
      mainLoader.width = book.width
      mainLoader.height = book.height
      ...
      mainLoader.source = "qt5_zoompage.qml"
      mainLoader.width = book.width
      mainLoader.height = book.height
      ...
      book.setProperties()
      mainLoader.source = "qt5_aboutdialog.qml"
      mainLoader.item.abouttext = "<H3>"+qsTr("Document path")+":<br><i>"+filePath+"</i></H3><H3>"+
      qsTr("Current page / Number of pages")+":<br><b>"+(spinner.currentIndex+1)+
      " / "+spinner.nbPages+"</b></H3><H3>"+
      qsTr("Elapsed time")+":<br>"+book.elapsedTime+"</H3><H3>"+
      qsTr("Battery status")+":<br>"+batteryStatus+"</H3>"
      mainLoader.width = book.width
      mainLoader.height = book.height
    }
  ...
  MouseArea{
    ...
    onPressAndHold: {
      ...
      mainLoader.source = "qt5_maintoolbar.qml"
